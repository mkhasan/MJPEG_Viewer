...
static unique_ptr<BasicDetector> net;
...
int main(int argc, char *argv[]) {
    ...
    try {
        ...
        net = std::make_unique<Detector>(useDetectors);
       ...
       //fileReader = make_unique<FileReader>("/home/hasan/raw_data/water_detector/pos_test", 60, 369);
        ...
        fileReader = make_unique<FileReader>("/home/hasan/raw_data/smoke_detector/jpegs", 2500, 161);
